/*
      Purpose: Handle client-side logic for the PERC-E Tools website, fetching wallet data from the backend API and populating the wallet list table. This is Stage 1, with “PERC-E Tools” branding.
